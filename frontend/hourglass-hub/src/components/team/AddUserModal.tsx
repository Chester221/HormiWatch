...
export function AddUserModal({ open, onOpenChange, onSuccess }: AddUserModalProps) {
  ...
  // ✅ HANDLE SUBMIT - Usa authApi para crear usuario
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // ✅ Usar authApi.signUp con los campos correctos
      await authApi.signUp(email, password, {
        full_name: fullName,
        name: fullName,        // ← Para que se guarde en profile.name
        role: role,
        phone: phone || null,
        cedula: cedula || null,
        is_active: true
      ...
      resetForm();
      onSuccess?.(); // ✅ Refresca la lista de Team
      onOpenChange(false);
